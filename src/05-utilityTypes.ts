...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, WorkMate } from "./myTypes";
...
function secureFindFriends(
  ...
  function intersection(friends: Friend[], colleagues: Colleague[]): WorkMate[] {
    let result : WorkMate[] = []
